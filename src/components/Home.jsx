...
const Home = () => {
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f] sm:flex flex-col space-y-4'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <p className='text-[#8892b0] py-4 max-w-[700px]'>I'm a full stack web developer specializes in creating and (occasionally designing) exceptional digital experiences.
